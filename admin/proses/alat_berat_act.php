...
mysqli_query($koneksi, "INSERT INTO alat_berat (
    kode, tipe, nomor_rangka, nomor_mesin, tahun_pembuatan, kondisi, status, lokasi, 
    kurs_beli, harga_beli_usd, harga_beli_idr, harga_jual_estimasi, 
    harga_sewa_all_in, harga_sewa_kosongan, 
    total_jam_operasional, jam_operasional_terakhir, deskripsi
) VALUES (
    '$kode', '$tipe', '$nomor_rangka', '$nomor_mesin', '$tahun_pembuatan', '$kondisi', '$status', '$lokasi',
    '$kurs_beli', '$harga_beli_usd', '$harga_beli_idr', '$harga_jual_estimasi',
    '$harga_sewa_all_in', '$harga_sewa_kosongan',
