...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'create_non_penjualan') {
            ...
            if (!$kategoriId) {
                redirectPage('error', 'Kategori pemasukan wajib dipilih.');
            }
            ...
            if (!$stmt->fetch()) {
                redirectPage('error', 'Kategori pemasukan tidak ditemukan.');
            }
...
/* Kategori untuk pemasukan non-penjualan. */
...
$incomeRows = $pdo->query("
    ...
    FROM pemasukan pm
    LEFT JOIN kategori_pemasukan k
...
.stat-orange{color:#c77c00!important}
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-label">Total Transaksi Pemasukan</div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-label">Pemasukan Penjualan</div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-label">Pemasukan Non Penjualan</div>
    </div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-label">Piutang Penjualan</div>
    </div>
</div>
