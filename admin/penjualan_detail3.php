...
<?php foreach ($paymentPlans as $paymentPlan): ?>
    ...
    $judulPembayaran = $printInfo['is_pelunasan'] ? 'INVOICE PELUNASAN' : 'INVOICE PEMBAYARAN TERMIN';
    ?>
    <div class="payment-invoice-print" id="paymentInvoice-<?php echo $paymentIdPrint; ?>">
        ...
        <div>No. Penjualan: <strong><?php echo h($sale['nomor_penjualan']); ?></strong></div>
        <?php if (!empty($paymentPlan['nomor_pemasukan'])): ?>
            <div>No. Bukti Pembayaran: <strong><?php echo h($paymentPlan['nomor_pemasukan']); ?></strong></div>
        <?php endif; ?>
        <hr>
        ...
        <table style="border:0;">
            <tr>
                ...
                <td style="border:0;"><strong>Tanggal Pembayaran</strong></td>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>Total Tagihan</td>
                    <td style="text-align:right;"><?php echo rupiah($grandTotal); ?></td>
                </tr>
                <tr>
                    <td>Pembayaran Termin <?php echo (int)$paymentPlan['termin_ke']; ?> (<?php echo h($paymentPlan['jenis_pembayaran']); ?>)</td>
                    <td style="text-align:right;"><strong><?php echo rupiah($paymentPlan['nominal']); ?></strong></td>
                </tr>
                <tr>
                    <td>Total Terbayar s.d. pembayaran ini</td>
                    <td style="text-align:right;"><?php echo rupiah($printInfo['cumulative_paid']); ?></td>
                </tr>
                <tr>
                    <td><strong>Sisa Tagihan Setelah Pembayaran</strong></td>
                    <td style="text-align:right;"><strong><?php echo rupiah($printInfo['remaining']); ?></strong></td>
                </tr>
            </tbody>
        </table>
