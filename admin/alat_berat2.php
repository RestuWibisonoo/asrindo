        ...
        <table class="dashboard-table alat-table" id="alatBeratTable">
            <thead>
                <tr>
                    ...
                    <th class="sortable" data-column="3">Tahun Pembuatan</th>
                    <th class="sortable" data-column="4">Kondisi</th>
                    <th class="sortable" data-column="5">Status</th>
                    <th class="sortable" data-column="6">Lokasi</th>
                ...
                <tr class="alat-filter-row">
                    ...
                    <th><input type="text" class="column-filter" data-filter-column="3" placeholder="Filter tahun"></th>
                    <th><input type="text" class="column-filter" data-filter-column="4" placeholder="Filter kondisi"></th>
                    <th>
                        <select class="column-filter" data-filter-column="5">
                    ...
                    <th><input type="text" class="column-filter" data-filter-column="6" placeholder="Filter lokasi"></th>
                    <th></th>
                </tr>
            </thead>
            ...
            <?php if (empty($units)): ?>
                <tr>
                    <td colspan="8" class="empty-table">Belum ada data alat berat.</td>
                </tr>
            <?php else: ?>
